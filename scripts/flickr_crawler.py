...
# key 06b15f9c8b5fa112e80cd84bae028a9a
# password b0afd9a5151fff6e
# Main method
def crawl(crawl_list, work_list):
    for i in range(len(crawl_list)):
        ...
        if not os.path.exists(output_dir):
            os.mkdir(output_dir)
        flickr_crawler = FlickrImageCrawler('06b15f9c8b5fa112e80cd84bae028a9a',  
